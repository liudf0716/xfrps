...
func RunDashboardServer(addr string, port int64) (err error) {
	...
	router.GET("/api/proxy/tcp/:page", httprouterBasicAuth(apiProxyTcp))
	router.GET("/api/proxy/udp/:page", httprouterBasicAuth(apiProxyUdp))
	router.GET("/api/proxy/ftp/:page", httprouterBasicAuth(apiProxyFtp))
	router.GET("/api/proxy/http/:page", httprouterBasicAuth(apiProxyHttp))
	router.GET("/api/proxy/https/:page", httprouterBasicAuth(apiProxyHttps))
	router.GET("/api/proxy/traffic", httprouterBasicAuth(apiProxyTraffic))
	router.GET("/api/client/online", httprouterBasicAuth(apiClientOnline))
	router.GET("/api/client/online/:page", httprouterBasicAuth(apiClientOnline))
	router.GET("/api/client/offline", httprouterBasicAuth(apiClientOffline))
	router.GET("/api/client/offline/:page", httprouterBasicAuth(apiClientOffline))
